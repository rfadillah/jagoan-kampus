...
<head>
  ...
  <meta name="description" content="Aplikasi Pelayanan Masyarakat Desa Pakel">
  <meta name="author" content="e-development.tech">

  <title>Login Aplikasi Pelayanan Masyarakat</title>
              ...
              <div class="col-md-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="assets/img/logo3.png" alt="Logo sekolah" class="logo-login">

                    <h1 class="h4 text-gray-900">Jagoan Kampus</h1>
                    <h1 class="h4 text-gray-900 mb-4"><b>PMB ITTelkom Surabaya</b></h1>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="registrasi.php">Registrasi Pengguna Baru!</a>
                  </div>
                </div>
              </div>
            </div>
