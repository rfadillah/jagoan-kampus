...
<head>
  ...
  <meta name="description" content="Aplikasi Pelayanan Masyarakat">
  <meta name="author" content="e-development.tech">

  <title>Aplikasi Pelayanan Masyarakat</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">Jagoan kampus</div>
      </a>
      ...
      <?php if ($_SESSION['level'] == 'admin') { ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="pendaftaran.php">
            <i class="fas fa-fw fa-list"></i>
            <span>Validasi Pendaftar</span></a>
        </li>
