...
<?php include('kelahiran_control.php'); ?>
...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Pengajuan Surat Kelahiran</h1>
  <form class="user" method="POST" action="<?= $base_url ?>/user/editprofil.php" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-8" style="margin-left:50px">
            <!-- <h1 class="h5 mb-1 text-gray-800"><b>Data Kepala Desa</b></h1> -->
            ...
            <hr class="text-gray-500" style="border: 1px solid; margin: 30px 0px 30px 0px;">
           

                <div class="form-group">
                    <label for="nama">Nama Ayah Kandung</label>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input name="anakke" type="number" class="form-control" id="anakke" placeholder="anak ke" value="">
                    </div>
                </div>
            ...
            <div class="col-md-12" style="margin-left:50px">
                <button type="submit" name="btn_simpan" value="simpan_profil" class="btn btn-primary mb-5">Kirim</button>
