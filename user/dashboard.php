  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="row">
          ...
          <div class="col-md-12">
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form class="user" method="POST" action="<?= $base_url ?>/user/dashboard.php">
        ...
        <?php } else if (isset($status) && $status == 4) { ?>
          <div class="col-md-12">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di Institut Teknologi Telkom Surabaya. pengumuman akan diumumkan melaui: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">Email</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">Institut Teknologi Telkom Surabaya</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda telah diterima di Institut Teknologi Telkom Surabaya</p>
        ...
        <?php } else if (isset($status) && $status == 3) { ?>
          <div class="col-md-12">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Pengumuman Hasil Seleksi</h6>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Anda Belum lolos. Nilai anda tidak memenuhi kriteria </p>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">Institut Teknologi Telkom Surabaya</marquee>
                  </div>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <p>Calon mahasiswa yang lolos seleksi wajib melakukan daftar ulang dengan membawa berkas sebagai berikut: </p>
              ...
              <p class="text-danger mt-3">* Wajib melakukan pendaftaran ulang apabila anda mendapat email konfirmasi telah diterima</p>
            </div>
          </div>
        </div>
