...
if (mysqli_num_rows($result_pendaftar)) {
    ...
    if (isset($_POST['btn_simpan']) && $_POST['btn_simpan'] == 'simpan_nilai') {
        ...
        if ($avg < 80 && $avg >= 0) {
            $sql_insert_nilai = "INSERT INTO nilai (nilai_un, nilai_us, nilai_uts_1, status, pendaftar_id) values ('$un', '$us', '$uts_1', 3, '$id_pendaftar')";
            ...
            $sql_insert_nilai = "INSERT INTO nilai (nilai_un, nilai_us, nilai_uts_1, status, pendaftar_id) values ('$un', '$us', '$uts_1', 4, '$id_pendaftar')";
