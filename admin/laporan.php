        ...
        while ($p = mysqli_fetch_array($all_pendaftar)) { ?>
          ...
          <tr>
            ...
            if ($p['status'] == 0) {
              ...
              $status = '<span class="badge badge-info">LOLOS & BUTUH VALIDASI</span>';
            }
            ...
            <td>
              ...
              <!-- <a href="<?= $base_url ?>/cetak/detail_surat_kelahiran.php?id=<?= $p['id'] ?>" class="btn btn-warning btn-sm" target="_blank">Cetak</a> -->
            </td>
          </tr>
