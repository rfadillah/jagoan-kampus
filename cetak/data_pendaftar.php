...
<img src="../assets/img/logo3.png" style="float: left; height: 60px">

<div style="margin-left: 20px">
    <br>
    <div style="font-size: 18px">Data PMB ITTelkom Surabaya | Tahun 2023 </div>
    
    <div style="font-size: 12px">Jl. Ketintang no 156 Surabaya</div>
    <br>
</div>
